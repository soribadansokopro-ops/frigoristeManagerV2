    ...
    <AppErrorBoundary>
      <Suspense fallback={<main className="loading-shell"><p>Chargement...</p></main>}>
        <Routes>
          ...
          <Route path="/level/:levelId/faults" element={<Navigate to="/missions" replace />} />
          <Route path="/level/:levelId" element={<LevelScreen />} />
          <Route path="/level/:levelId/composants" element={<Navigate to="../zone/meuble" relative="path" replace />} />
